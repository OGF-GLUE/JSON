...
public class ComputingManagerAssociations extends ManagerAssociations {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ComputingManagerAssociations) == false) {
            return false;
        }
        ComputingManagerAssociations rhs = ((ComputingManagerAssociations) other);
